// JS for weather app to fetch weather data from openweathermap.org and pictures from unsplash.com

// Importing dotenv for API keys
require('dotenv').config();

// Keys for fetching weather data and picture from cities
const weatherKey = process.env.WEATHER_API_KEY; // Key for OpenWeatherMap
const unsplashKey = process.env.UNSPLASH_API_KEY; // Key for Unsplash
